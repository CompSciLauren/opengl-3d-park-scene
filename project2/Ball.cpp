...
// This simple Ball class creates a Ball along the x-axis:
// (x1, yb, zb) to (x2, yb, zb) with radius = r
Ball::Ball(ShaderIF* sIF, double yb, double zb, double r) : shaderIF(sIF)
{
...
void Ball::defineBall(double x1, double x2, double yb, double zb, double r)
{
...
bool Ball::handleCommand(unsigned char anASCIIChar, double ldsX, double ldsY)
{
	// Ball does not look for events. Just hand off back to inherited handleCommand
