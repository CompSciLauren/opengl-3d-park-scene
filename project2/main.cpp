...
{	
	c.addModel(new Tree(sIF, 0, 1.4, 0.05, 0.2, -0.009, 1.4, 0.022, 0.022, 0.022));
	c.addModel(new Tree(sIF, 0.03, 1.4, 0.05, 0.2, 0.019, 1.4, 0.022, 0.022, 0.022));
	c.addModel(new Tree(sIF, 0.06, 1.4, 0.05, 0.2, 0.049, 1.4, 0.022, 0.022, 0.022));
}
